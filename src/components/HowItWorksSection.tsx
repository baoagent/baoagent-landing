...
const AgentWorkflowsSection: React.FC<AgentWorkflowsSectionProps> = ({ messages }) => {
  ...
  const cards = [
    {
      title: t('howItWorks.scheduling.title'),
      description: t('howItWorks.scheduling.description'),
      icon: (
    ...
    {
      title: t('howItWorks.staffing.title'),
      description: t('howItWorks.staffing.description'),
      icon: (
    ...
    {
      title: t('howItWorks.billing.title'),
      description: t('howItWorks.billing.description'),
      icon: (
    ...
    {
      title: t('howItWorks.analytics.title'),
      description: t('howItWorks.analytics.description'),
      icon: (
